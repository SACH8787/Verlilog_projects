...
HD_PWD='C:/Users/Sach/FPGA PROJ/1_d_convolution_vga/1_d_convolution_vga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tp.tcl -notrace

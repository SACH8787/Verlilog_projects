...
HD_PWD='C:/Users/Sach/flip_flop_1/flip_flop_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_flip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_flip.tcl

...
HD_PWD='C:/Users/Sach/flip_flop_1/flip_flop_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_flip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_flip.tcl -notrace
